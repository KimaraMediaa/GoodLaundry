                    ...
                    <div class="card">
                        <div class="card-header">
                          <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs">
                            <li class="nav-item">
                              <a href="#tabs-profile-7" class="nav-link active tabList" data-bs-toggle="tab"><!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>
                                List</a>
                            </li>
                            <li class="nav-item">
                                <a href="#tabs-home-7" class="nav-link tabMaps" data-bs-toggle="tab"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
...
<script type="text/javascript">
    $(function () {
        ...
        $('.tabMaps').click(function (e) {
            e.preventDefault();
            $('.tabList').removeClass('active');
            $('#tabs-profile-7').removeClass('active show');
            $('.tabMaps').addClass('active');
            $('#tabs-home-7').addClass('active show');
            maps();
        });

        function maps() {
            var map = L.map('map');
            map.setView([-8.5492395, 115.2260451], 10);
